...
// android/KEYSTORE.md) -- gitignored, never committed. CI writes it from
// GitHub secrets at build time; falls back to the debug key otherwise so
// local builds and `flutter build apk --release` keep working before a
...
android {
    ...
    defaultConfig {
        applicationId = "com.gryphonheart.koda"
