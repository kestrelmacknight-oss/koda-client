...
//
// Dialog that allows importing a Discord server template into a Koda server.
// Accepts a discord.new/CODE URL or raw template code.
// Safe default: adds to existing structure.
// Destructive option (replace all) is clearly highlighted.
...
class _DiscordImportDialogState extends State<DiscordImportDialog> {
  ...
  Future<void> _preview() async {
    ...
    if (result != null && result['ok'] == true) {
      setState(() {
        _preview  = result['template'] as Map<String, dynamic>?;
        _previewed = true;
        _loading  = false;
      });
    } else {
              ...
              if (_error != null) ...[
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(
                        color: KodaColors.accent.withOpacity(0.3)),
                  ),
                  child: Text(_error!,
              ...
              if (preview != null) ...[
                ...
                Container(
                  ...
                  child: Column(
                      ...
                      children: [
                    Text(
                      preview['name'] as String? ?? 'Template',
                      style: const TextStyle(
                          color: KodaColors.text1,
                ...
                Container(
                  ...
                  child: Row(children: [
                    ...
                    Switch(
                      ...
                      onChanged: (v) async {
                        if (v) {
                          // Require extra confirmation for destructive action
                          final confirmed = await showDialog<bool>(
                            ...
                            builder: (_) => AlertDialog(
                              ...
                              title: const Text('Replace server structure?',
                                  style:
                                      TextStyle(color: KodaColors.accent)),
                              content: const Text(
